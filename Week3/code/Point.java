...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        /* YOUR CODE HERE */
        if (this.compareTo(that) == 0) return Double.NEGATIVE_INFINITY;     // 2 points are equal
        if (this.x == that.x) return Double.POSITIVE_INFINITY;              // line is vertical
        if (this.y == that.y) return +0.0;                                  // line is horizontal
    ...
    public Comparator<Point> slopeOrder() {
        /* YOUR CODE HERE */
        Comparator<Point> mySlopeOrder = new SlopeOrder();
        return mySlopeOrder;
    }
